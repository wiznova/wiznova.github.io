...
from markdown_base import markdown_factory, convert_markdown
...
def environment_factory(
    ...
    # Resolving this locally doesn't work, but the Templates dir works
    # loaders.append(PackageLoader('blagpk', 'templates'))
